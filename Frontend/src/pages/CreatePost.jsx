    ...
    <div>
      <div className='px-6 md:px-[200px] mt-8  bg-slate-300'>
        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8'>
          ...
          <button className='bg-blue-800 px-4 w-full py-2 text-white font-semibold md:w-auto mt-2 md:mt-0 md:text-xl text-lg hover:bg-slate-200 hover:text-black hover:border-2 border-blue-800 '>Add Post</button>
        </form>
      </div>
    </div>
  )
